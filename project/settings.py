...
# Email Configuration
if DEBUG:
    # Use console backend by default, but if user wants to test real email:
    # We can use SMTP. User specifically asked for integration.
    # Let's force SMTP for this task.
