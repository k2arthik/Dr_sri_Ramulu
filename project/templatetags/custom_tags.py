...
@register.simple_tag
def utc_to_local(utc_datetime, user_timezone=None, date_format="%b. %d, %Y, %I:%M %p"):
    ...
    if isinstance(utc_datetime, str):
        try:
            ...
            return utc_datetime # Return as is if format unknown
    else:
        utc_datetime_obj = utc_datetime
    ...
    if user_timezone:
        try:
            ...
            specific_datetime = utc_datetime_obj.astimezone(target_tz)
            return specific_datetime.strftime(date_format)
        except pytz.UnknownTimeZoneError:
            pass

    return utc_datetime_obj.strftime(date_format)
